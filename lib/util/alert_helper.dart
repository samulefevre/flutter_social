...
class AlertHelper {
  ...
  Future<void> changeUserAlert(BuildContext context,
    ...
    MyTextField descTF = MyTextField(
        controller: desc, hint: me.description ?? "Aucune description.");
    MyText title =
        MyText("Changer les données de l'utilisateur", color: pointer);

    FlatButton showDialogValidateBtn(BuildContext ctx) {
      return FlatButton(
